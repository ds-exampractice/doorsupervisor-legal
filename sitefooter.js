          ...
          <div style="max-width:1200px;margin:0 auto;padding:56px 24px 28px">
            <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(min(200px,100%),1fr));gap:40px 32px">
              <div style="max-width:280px">
                ...
                <a href="JobRoles.html" class="brand-link">Browse the 15 job roles <span style="font-size:14px;line-height:1">&#8594;</span></a>
              ...
              <div>
                ...
                <div style="display:flex;flex-direction:column;gap:11px">
                  ...
                  <a href="mailto:info@doorsupervisorexam.co.uk" style="word-break:break-all">info@doorsupervisorexam.co.uk</a>
                  <a href="mailto:ds.exampractice@gmail.com" style="word-break:break-all">ds.exampractice@gmail.com</a>
                </div>
              </div>
              <div>
