(function () {
  ...
  const ITEMS = [
    ...
    { k:'roles',    label:'Job Roles',    href:'learn_the_job.html' },
    { k:'privacy',  label:'Privacy',      href:'privacy_policy.html' },
    { k:'terms',    label:'Terms',        href:'terms_and_conditions.html' },
    { k:'deletion', label:'Data Deletion',href:'data_deletion.html' },
